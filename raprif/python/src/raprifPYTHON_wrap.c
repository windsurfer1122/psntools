...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__raprif

#else
#  define SWIG_init    init_raprif

#endif
#define SWIG_name    "_raprif"
...
extern "C" {
#endif
SWIGINTERN int Swig_var_rap_aes_key_set(PyObject *_val SWIGUNUSED) {
  SWIG_Error(SWIG_AttributeError,"Variable rap_aes_key is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_rap_aes_key_get(void) {
  PyObject *pyobj = 0;
  
  {
    pyobj = PyByteArray_FromStringAndSize((char *) rap_aes_key, RAPRIF_KEYSIZE_AES);
  }
  return pyobj;
}


SWIGINTERN PyObject *_wrap_rif2rap_rounds(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (PyBytes_Check(swig_obj[0])) {
      ...
      arg1 = (unsigned char *) PyBytes_AsString(swig_obj[0]);
    } else if (PyByteArray_Check(swig_obj[0])) {
      len = PyByteArray_Size(swig_obj[0]);
      arg1 = (unsigned char *) PyByteArray_AsString(swig_obj[0]);
    } else {
      PyErr_SetString(PyExc_TypeError, "rif2rap_rounds: Type of argument #1 is neither bytes nor bytearray.");
      SWIG_fail;
    }
    if (len < RAPRIF_KEYSIZE_RAPRIF) {
      PyErr_SetString(PyExc_ValueError, "rif2rap_rounds: Size of argument #1 is less than raprif.RAPRIF_KEYSIZE_RAPRIF.");
      SWIG_fail;
    }
    // re-create "constraints.i/%apply Pointer NONNULL" via typemap, enhance message with function name and argument number
    if (!arg1) {
      PyErr_SetString(PyExc_ValueError, "rif2rap_rounds: Argument #1 received a NULL pointer.");
      SWIG_fail;
    }
  }
...
SWIGINTERN PyObject *_wrap_rap2rif_rounds(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  unsigned char *arg1 = (unsigned char *) (unsigned char *)0 ;
  unsigned char **arg2 = (unsigned char **) (unsigned char **)0 ;
  size_t *arg3 = (size_t *) (size_t *)0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    if (PyBytes_Check(swig_obj[0])) {
      ...
      PyErr_SetString(PyExc_TypeError, "rap2rif_rounds: Type of argument #1 is neither bytes nor bytearray.");
      SWIG_fail;
    }
    if (len < RAPRIF_KEYSIZE_RAPRIF) {
      PyErr_SetString(PyExc_ValueError, "rap2rif_rounds: Size of argument #1 is less than raprif.RAPRIF_KEYSIZE_RAPRIF.");
      SWIG_fail;
    }
    // re-create "constraints.i/%apply Pointer NONNULL" via typemap, enhance message with function name and argument number
    if (!arg1) {
      PyErr_SetString(PyExc_ValueError, "rap2rif_rounds: Argument #1 received a NULL pointer.");
      SWIG_fail;
    }
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "rif2rap_rounds", _wrap_rif2rap_rounds, METH_O, NULL},
	 { "rap2rif_rounds", _wrap_rap2rif_rounds, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_Python_SetConstant(d, "__version__",SWIG_FromCharPtr("1.0.0"));
  SWIG_Python_SetConstant(d, "RAPRIF_KEYSIZE_AES",SWIG_From_int((int)(16)));
  SWIG_Python_SetConstant(d, "RAPRIF_KEYSIZE_RAPRIF",SWIG_From_int((int)(16)));
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "rap_aes_key", Swig_var_rap_aes_key_get, Swig_var_rap_aes_key_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
